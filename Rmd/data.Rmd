...
### Texas Vaccination
To complete our county-level vaccination data, we collected  `r length(unique(tx_vaccination$date))` days of county-level vaccination data from the Texas Department of Health and Human services COVID-19 Vaccination in Texas Summary. 

Variables: 
1. County_Name - the county name, character
...
To complete our county-level vaccination data, we obtained the total number of people vaccinated and the total number of people who have received at least one dose from all counties in California with fewer than 20,000 residents from democratandchronicle.com. 
...
2. County Name - name of the county, character
