...
We obtained county-level estimates of the percentage of the population who are hesitant to receive the COVID-19 vaccine from the CDC (see appendix for details). This dataset also includes racial demographics and SVI information (see appendix for details), as well as geographical information because it was designed to produce a map.
