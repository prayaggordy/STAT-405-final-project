...
This chart suggests that there is no relationship between the severity of the pandemic and residents' decisions to get vaccinated. Even some counties where close to 1-in-100 residents died from Covid are extremely under-vaccinated, while some counties that were not hard-hit are highly vaccinated.
