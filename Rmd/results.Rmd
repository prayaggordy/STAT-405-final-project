...
Over time, vaccination levels in higher vulnerability counties have tapered off at lower percentages than those of lower vulnerability counties, which the plot on the right (showing the average vaccination rate of counties over time grouped by SVI category) clearly demonstrates. However, the distributions of vaccination rates in counties of broadly differing SVI categories overlap considerably, as indicated by the histograms on the left, showing that SVI alone is not a strong predictor of county vaccination rates. 
...
```{r}
#whatever Prayag decides to call the function for plotting SVI stuff
```
